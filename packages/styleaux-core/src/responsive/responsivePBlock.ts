...
//   IResponsivePOptions,
// } from './types'
// import {Dict, Maybe, IDictionary, WithTheme} from '../types'
...
//   responsive: <A = {}, B extends {} = never, C extends {} = never>(
//     responsiveConfig: IResponsiveOptions<A, B, C>,
//   ) => IStyles | undefined,
...
//       transform,
//       ...localoptions
//     }: IResponsivePOptions<P, T, B>, // IResponsivePOptions<P, T, DT> & TransformPOptions, //IDictionary, //IResponsivePOptions<P, T, DT>,
//   ) {
//     let transformOptions = {...globalOptions, ...localoptions}
//     return function responsiveP(props: WithTheme<P, T, B>) {
//       let css
...
//       return responsive<P, T, B>({
//         value: curentValue, // safeMapValues(falseToNull, curentValue),
//         defaultValue,
//         cssProp: '',
//         transformer,
