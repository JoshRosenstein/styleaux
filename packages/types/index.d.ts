...
type Style<S extends SimpleStyle=SimpleStyle> =
  | S
  | { [key: string]: Style }
...
export type CleanLiteralStringUnion<T extends string>=HasLiteralUnion<T> extends true? Exclude<T,object>  : T

export type UndoLiteralStringUnion<T extends string>=HasLiteralUnion<T> extends true? Exclude<T,object> | string  : T
