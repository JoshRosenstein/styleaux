...
export const createBorderBlockStartWidth = <
  ...
  Media = never,
  Theme= never,
>({key, transformValue}: Partial<Pick<StyleOptions<BorderBlockStartWidthProps<T>,Theme>,'key'| 'transformValue'>> =
{}) =>
...
export const createBorderBlockStartWidthRule = <T = BorderBlockStartWidthProperty, P=unknown>(
