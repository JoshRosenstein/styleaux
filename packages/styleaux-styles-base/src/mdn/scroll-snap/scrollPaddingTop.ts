...
export const createScrollPaddingTop = <
  ...
  Media = never,
  Theme= never,
>({key, transformValue}: Partial<Pick<StyleOptions<ScrollPaddingTopProps<T>,Theme>,'key'| 'transformValue'>> =
{}) =>
...
export const createScrollPaddingTopRule = <T = ScrollPaddingTopProperty, P=unknown>(
