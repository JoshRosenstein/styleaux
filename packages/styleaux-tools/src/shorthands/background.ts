import * as CSS from '@styleaux/csstype'
  ...
  const backgroundV=(...backgrounds:BackgroundOptions[]):CSS.BackgroundProperty=> {
...
const backgroundS=(...backgrounds:BackgroundOptions[])=> ({'background':backgroundV(...backgrounds)})
